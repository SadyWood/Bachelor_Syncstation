// apps/workstation-web/src/widgets/AdminWidgets/PermissionsCatalog.tsx
...
function SortIcon({ sortKey, sortDir, column }: SortIconProps) {
              ...
              <tr>
                <th>
                  <button onClick={() => toggleSort('permissionCode')}>
                    Permission Code
                    <SortIcon sortKey={sortKey} sortDir={sortDir} column="permissionCode" />
                  </button>
                </th>
                <th>
                  <button onClick={() => toggleSort('description')}>
                    Description
                    <SortIcon sortKey={sortKey} sortDir={sortDir} column="description" />
                  </button>
                </th>
              </tr>
            </thead>
