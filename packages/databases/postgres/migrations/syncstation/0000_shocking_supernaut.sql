CREATE TYPE "public"."attachment_type" AS ENUM('image', 'video', 'document');--> statement-breakpoint
CREATE TYPE "public"."sync_status" AS ENUM('local', 'pending', 'synced', 'failed');--> statement-breakpoint
